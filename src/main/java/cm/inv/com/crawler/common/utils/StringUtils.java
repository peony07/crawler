...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static String getBusinessCode(String prefix){
        ...
        String random = StringUtils.getRandomNum(5);
        String code = df.format(new Date())+random;
    ...
    public static void main(String[] args) {
		System.out.println(RegExpValidatorUtils.isRegistrationInvitationCode("1234"));
	}
}
