 ...
 * .
 */
package cm.inv.com.crawler.common.persistence;

import cm.inv.com.crawler.common.config.Global;
import cm.inv.com.crawler.common.utils.CookieUtils;
...
//		sb.append("<input disabled=\"true\" type=\"text\" value=\""+pageNo+"\" onkeypress=\"var e=window.event||this;var c=e.keyCode||e.which;if(c==13)");
//		sb.append(funcName+"(this.value,"+pageSize+",'"+funcParam+"');\" onclick=\"this.select();\"/>页，每页显示 ");
		sb.append(pageNo+"&nbsp;&nbsp;&nbsp;页，每页显示&nbsp;&nbsp;");
//		sb.append("<input disabled=\"true\" type=\"text\" value=\""+pageSize+"\" onkeypress=\"var e=window.event||this;var c=e.keyCode||e.which;if(c==13)");
//		sb.append(funcName+"("+pageNo+",this.value,'"+funcParam+"');\" onclick=\"this.select();\"/> 条，");
		sb.append(pageSize+"&nbsp;&nbsp;条，");
