...
//	}
	...
	public static void sendFtlMail(String toMailAddr, String subject,
		...
		try {
			hemail.setHostName(Global.getConfig("emailhostname"));
			hemail.setSmtpPort(Integer.parseInt(Global.getConfig("emailsmtpport")));
			hemail.setCharset("utf-8");
			hemail.addTo(toMailAddr);
			hemail.setFrom(Global.getConfig("emailfrom"), Global.getConfig("emailfromName"));
			hemail.setAuthentication(Global.getConfig("emailusername"), Global.getConfig("emailpassword"));
	...
	public static void sendCommonMail(String toMailAddr, String subject,
		...
		try {
			...
			hemail.setSmtpPort(Integer.parseInt(Global.getConfig("emailsmtpport")));
			hemail.setCharset("utf-8");
			if(StringUtils.isNotEmpty(toMailAddr)){
				hemail.addTo(toMailAddr);
			}
			hemail.setFrom(Global.getConfig("emailfrom"), Global.getConfig("emailfromName"));
			hemail.setAuthentication(Global.getConfig("emailusername"), Global.getConfig("emailpassword"));
