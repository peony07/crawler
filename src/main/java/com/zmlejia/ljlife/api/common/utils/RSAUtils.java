...
public abstract class RSAUtils {
	...
	private static boolean isCreateKeyPairFile() {
		...
		if(rsaPairFile.exists()&&!rsaPairFile.isDirectory()){
			long time = rsaPairFile.lastModified();
			if(DateUtils.getDistanceOfTwoDate(new Date(time), new Date())>30){
				rsaPairFile.delete();
				createNewKeyPair = true;
			}
		}
     ...
     * 乐家慧RSA加密解密不变key
     */
    private static String modulus = "00ee0b122ebeb605dce665b42d218590dee099247b0cace921334242879cb133998a1022a609dcbd7e7f93ffda17b237160c276ac4783eabdf37d6563fd99b6d59";
    private static String publicExponent = "010001";
    private static String privateExponent = "0c097f47e1d8ee7ef71f9976d6c51c4848ef358b0b5f0b02e4c6aafa948fd95e07472c17f38e524188a1820a7798eb65c8045b5c07f28ee4444845950db22121";
     ...
     * @return RSAPublicKey
     */
    private static RSAPublicKey getFinalPublicKey() {
        return RSAUtils.getRSAPublicKey(modulus, publicExponent);
    }
     ...
     */
    private static RSAPrivateKey getFinalPrivateKey() {
        return RSAUtils.getRSAPrivateKey(modulus, privateExponent);
    }
    ...
    public static String encrypt(String decrypttext){
        return RSAUtils.encryptString(getFinalPublicKey(), decrypttext);
    }
    ...
    public static String decrypt(String encrypttext){
        return RSAUtils.decryptString(getFinalPrivateKey(), encrypttext);
    }
