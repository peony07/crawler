...
public class JPushPmUtils    {
	private static Log log = LogFactory.getLog(JPushPmUtils.class);
	public static String master = "4ad4941200ef1e5bde25b227";
	public static String appkey = "88dc0a6dee4bd23a0fe92985";
...
/*						sendContext+="【"+Global.getConfig("productName")+"】";*/
	...
	public static void main(String[] args) throws Exception {
		JPushPmUtils.pushMsg("尊敬的xx小区业主，您好！您发起的故障报修已安排社区专属管家进行处理，请您安心等待。有问题可致电4008115251垂询，我们将竭诚为您服务", "18210225831");
	}
